            ...
            <div className="grid md:grid-cols-2 gap-8">
              {displayedNews.map((news) => {
                ...
                return (
                  <article
                    key={news.id}
                    className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow p-6 border border-gray-100"
                  >
                    <div className="mb-4">
                      <span
                    ...
                    <h3 className="text-2xl font-bold mb-3 text-gray-800 hover:text-orange-500 transition-colors">
                      {news.title}
                    </h3>
