  ...
  const getRouteInfo = () => {
    if (formData.origin && formData.destination) {
      if (
        ...
        return {
          link: "/trade-routes/import-from-china",
          message:
      ...
      if (
        ...
        return {
          link: "/trade-routes/import-from-middle-east",
          message:
      ...
      if (
        ...
        return {
          link: "/trade-routes/export-to-middle-east",
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Link
              href="/trade-routes/import-from-china"
            ...
            <Link
              href="/trade-routes/import-from-middle-east"
              className="bg-white rounded-lg shadow-md hover:shadow-xl transition-all overflow-hidden group"
            >
            ...
            <Link
              href="/trade-routes/export-to-middle-east"
              className="bg-white rounded-lg shadow-md hover:shadow-xl transition-all overflow-hidden group"
            >
